...
2. Crear carrera
    ...
    **crearCarrera**
    ...
    | Parámetro | Tipo de dato | Observación |
    | --- | --- | --- |
    | Nombre | String | Validar que solo sean letras |
3. Registrar docente
...
| --- | --- | --- |
| YYYY-MM-DD hh:mm:ss | Se ha realizado una
acción en la tabla
“Nombre”. | INSERT/UPDATE/DELETE |
...
- El gestor de base de datos a utilizar es **MySQL**.
